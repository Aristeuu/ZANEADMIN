                  ...
                  <form id="ctedForm" action="{{route('equipe.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="twitter" class="form-control" id="twitter" placeholder="" required>
                      </div>
                      <div class="form-group">
                        <label for="titulo">Instagram</label>
                        <input type="text" name="instagram" class="form-control" id="instagram" placeholder="" required>
                      </div>
